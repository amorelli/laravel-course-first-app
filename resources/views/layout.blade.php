    ...
    <div id="header" class="container">
      ...
      <div id="menu">
        ...
        <li class="{{ Request::path() === '/' ? 'current_page_item' : ''}}"><a href="/" accesskey="1" title="">Homepage</a></li>
          ...
          <!-- Another way of setting the active link color is to use the Request::is method. You can also use a wildcard in the route (*) if needed. -->
